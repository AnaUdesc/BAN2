...
public class AnimaisBean {
   ...
   public AnimaisBean(String nome_animal, String especie_animal, String raca, int idade, String sexo_animal, String observacao) {
    ...
    */
    ...
    public String toString(){
        ...
        sb.append("Nome Animal: "+nome_animal+" Especie Animal: "+especie_animal+" Raca Animal: "+raca+
                " Idade Animal: "+idade+" Sexo Animal: "+sexo_animal+" Observacao: "+observacao);
        /*if(ambulatorio!= null)
